...
{
    Xeth::KeyAttributesReader<Xeth::StealthKeyStore> reader("key/3oTYcWA1XeEvkx4JB3MKq8FuSVgESQZG53L8DhMRWY7rnh8tb15cdDLVfGDZKZ5K3XYmwXg3mNSqiZvcWAtXFym4QMR9owhBGTFcgjZ.skey");
...
void KeyAttributesReaderTest::checkNonExistentStealthKey()
{
    ...
    try
    {
        Xeth::KeyAttributesReader<Xeth::StealthKeyStore> reader("key/3oTYcKA1XeEvkx4JB3MKq8FuSVgESQZG53L8DhMRWY7rnh8tb15cdDLVfGDZKZ5K3XYmwXg3mNSqiZvcWAtXFym4QMR9owhBGTFcgjZ.skey");
    }
    catch(...)
    {
        thrown = true;
...
{
    Xeth::KeyAttributesReader<Xeth::EthereumKeyStore> reader("key/UTC--2016-02-09T04:33:27.434985--d4e7fd527d69f33ad9f88e16dcb218598dc3a3ee");
...
void KeyAttributesReaderTest::checkNonExistentEthereumKey()
{
    ...
    try
    {
        Xeth::KeyAttributesReader<Xeth::EthereumKeyStore> reader("key/UTC--2016-02-09T04:33:27.434985--r4e7fd527d69f33ad9f88e16dcb218598dc3a3ee");
    }
    catch(...)
    {
        thrown = true;
