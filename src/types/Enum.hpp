...
static const QString JOIN(CLASS_NAME,_names)[] = {PARSE_VARGS(ESCAPE_ENUM_NAME, __VA_ARGS__)};                                    \
...
{                                                                                                                                 \
    ...
    public:                                                                                                                       \
        ...
        inline static const QString & ToString(CLASS_NAME::Value value){ return JOIN(CLASS_NAME,_names)[value];}                  \
        inline operator Value() const { return _value;}                                                                           \
        inline operator const QString &() const {return toString();}                                                              \
        ...
        inline bool operator > (const CLASS_NAME &e) const {return _value>e._value;}                                              \
   public slots:                                                                                                                  \
        inline const QString &toString() const { return JOIN(CLASS_NAME,_names)[_value];}                                         \
