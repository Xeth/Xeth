...
*/
	...
	//seedPoints: [],
	//isStillSeeding: true,
	callback: {pool:null, complete:null},
	//seederDependentWallets: ["singlewallet", "paperwallet", "bulkwallet", "vanitywallet", "splitwallet"],
	
	init: function (_pool, _complete){
		ninja.seeder.callback.pool = _pool;
		ninja.seeder.callback.complete = _complete;
	...
	showPool: function () {
		...
		*/
		...
		// + "%";
		ninja.seeder.callback.pool(percentSeeded);
		/*
...
*/
	seedingOver: function () {
		...
		//console.log(poolHex);
		ninja.seeder.callback.complete(poolHex);
		/*
		// run sync unit tests
