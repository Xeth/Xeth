...
elseif(BIN_DOWNLOAD)
    ...
    message(FATAL_ERROR "geth not found, please use -DGETH_PATH=... or -DBIN_DOWNLOAD=1 flags")
endif()
...
elseif(BIN_DOWNLOAD)
    ...
    message(FATAL_ERROR "ipfs not found, please use -DIPFS_PATH=... or -DBIN_DOWNLOAD=1 flags")
endif()
